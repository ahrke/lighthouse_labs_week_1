...
const howManyBottlesCanIGet = (bottles, caps, callback) => {
  ...
  return newBottles 
    + howManyBottlesCanIGet([(newBottles + remainingBottles),earnedFromBottles], 
...
const poppinBottles = (invested) => {
  ...
  let bottlesEarnedTotal = howManyBottlesCanIGet([bottlesInitial,0],[bottlesInitial,0], tracker);
